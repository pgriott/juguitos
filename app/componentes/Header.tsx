...
export default function Header () {
    return(
        <div className="sm:flex justify-between items-center mx-10 py-6 bg-yellowLight border-b-2 border-greenDark">
            <div className="sm:flex items-center">
                ...
                <p className="mt-4 sm:mt-auto pb-1 shantell-sans font-medium text-greenDark">Jugos naturales para todos los gustos</p>
            </div>
